...
{
    public partial class frmInfoCrmNaoGestante5 : Form
    {
...
int nHeightEllipse
        ...
        {
            this.Close();
            var frmicng6 = new frmInfoCrmNaoGestante6();
            frmicng6.Show();
        }
        ...
        private void frmInfoCrmNaoGestante5_Load(object sender, EventArgs e)
        {
